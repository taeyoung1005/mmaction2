...
config_path = '/mmaction2/work_dirs/my_custom_config_tsn/my_custom_config_tsn.py'
checkpoint_path = '/mmaction2/work_dirs/my_custom_config_tsn/best_acc_top1_epoch_20.pth'
